...
import chessv.search.MainSearch
import chessv.search.SearchConstants
import chessv.search.SearchOptions
...
object MultiThreadedSearch {
    ...
    class HelperThread(innerId: Int) : Thread() {
        ...
        private val aspirationWindow = SearchConstants.ASPIRATION_WINDOW_SIZE - ((cycleIndex / SMP_MAX_CYCLES) % 6)
